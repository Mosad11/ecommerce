                          ...
                          child: Row(
                            ...
                            children: [
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          '\$${controller.orderList[index].products[0].price.round()}',
                                          style: TextStyle(
                                              fontSize: 14,
                                              color: primaryColor),
                                        ),
                                    ...
                                    Container(
                                      decoration: BoxDecoration(
                                          ...
                                          color: controller
                                                  .orderList[index].isDeliverd
                                              ? primaryColor
                                              : Colors.yellow[600]),
                                      padding: const EdgeInsets.all(7.5),
                                      child: Text(
                                        controller.orderList[index].isDeliverd
                                            ? 'Delivered'.tr
                                            : 'In Transit'.tr,
                                      ),
                                    )
                              ...
                              Container(
                                ...
                                child: Image.network(
                                  controller.orderList[index].products[0].image,
                                  fit: BoxFit.cover,
                                ),
                              )
                            ],
